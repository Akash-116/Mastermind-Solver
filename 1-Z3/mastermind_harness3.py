...
#code = [11, 8, 7, 12, 6, 6, 8, 16, 7, 13, 1, 16, 9, 13, 18, 19, 15, 7, 0, 14]
...
def play_game():
    ...
    while red < k:
        ...
        if play_self:
            ...
            print("found a move:",len(guess_list))
            print( move )
...
#print("For n = "+str(n)+" and k = "+str(k))
#print("Average Time for a run is "+ str((end-start)/N))
#print("Average steps are "+str(nmove/N))
